...
final List<IconMenu> salesAnalysisMaster = [
  ...
  IconMenu(title: 'menu_sub_item_status'.tr, iconData: CupertinoIcons.square_stack_3d_down_right_fill, path: ROUTE_MENU_ITEM_STATUS), // 품목 현황
];
...
final List<IconMenu> inventoryAnalysisMaster = [
  IconMenu(title: 'menu_sub_inventory_report'.tr, iconData: Icons.inventory, path: ROUTE_MENU_INVENTORY_REPORT),
  // 재고현황
  IconMenu(
