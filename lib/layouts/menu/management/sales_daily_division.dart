      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Container(
              child: ShowDoubleValueField(null,
                  '수량\n(BOX/EA)',
                  '금액'),
            ),
            Expanded(
