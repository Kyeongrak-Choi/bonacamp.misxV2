                          ...
                          child: Column(
                            children: [
                              ...
                              Visibility(
                                ...
                                child: Column(
                                  children: [
                                    SumItemTable('전일재고',  numberFormat.format(Get.find<InventoryInOutReportController>().sumLastBoxQuantity),
                                        numberFormat.format(Get.find<InventoryInOutReportController>().sumLastBottleQuantity), 0),
                                    SumItemTable('금일재고', numberFormat.format(Get.find<InventoryInOutReportController>().sumCurrentBoxQuantity),
                                        numberFormat.format(Get.find<InventoryInOutReportController>().sumCurrentBottleQuantity), 0),
                                    SumItemTable('입고',  numberFormat.format(Get.find<InventoryInOutReportController>().sumInBoxQuantity),
                                        numberFormat.format(Get.find<InventoryInOutReportController>().sumInBottleQuantity), 0),
                                    SumItemTable('출고', numberFormat.format(Get.find<InventoryInOutReportController>().sumOutBoxQuantity),
                                        numberFormat.format(Get.find<InventoryInOutReportController>().sumOutBottleQuantity), 0),
                                    SumItemTable('실사', numberFormat.format(Get.find<InventoryInOutReportController>().sumPhysicalBoxQuantity),
                                        numberFormat.format(Get.find<InventoryInOutReportController>().sumPhysicalBottleQuantity), 0),
                                  ],
                                ),
                              ),
                            ],
