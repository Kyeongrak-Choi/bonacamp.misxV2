        ...
        child: Padding(
          ...
          child: ListView(
            children: [
              ...
              ShowLongTitleField(
                  titleName: '관리업체수',
                  value: controller.controllerModel != null ? f.format(int.parse(controller.controllerModel.custCnt ?? '0')) : '0'),
              Container(
                  width: 500,
                  padding: EdgeInsetsDirectional.fromSTEB(10, 0, 20, 0),
                  child: Divider(color: context.theme.primaryColor, thickness: 0.5)),
              ShowLongTitleField(
                  titleName: '매출공급가',
                  value: controller.controllerModel != null ? f.format(int.parse(controller.controllerModel.suppAmt ?? '0')) : '0'),
              ShowLongTitleField(
                  titleName: '매출원가',
              ...
              ShowLongTitleField(
                  titleName: '비용합계',
                  value: controller.controllerModel != null ? f.format(int.parse(controller.controllerModel.costSum ?? '0')) : '0'),
              Container(
                  width: 500,
                  padding: EdgeInsetsDirectional.fromSTEB(10, 0, 20, 0),
                  child: Divider(color: context.theme.primaryColor, thickness: 0.5)),
              ShowLongTitleField(
                  titleName: '채권잔액',
                  value: controller.controllerModel != null ? f.format(int.parse(controller.controllerModel.perddBal ?? '0')) : '0'),
              ShowLongTitleField(
                  titleName: '대여금잔액',
