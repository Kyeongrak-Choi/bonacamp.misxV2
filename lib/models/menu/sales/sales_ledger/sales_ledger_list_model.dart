...
class SalesLedgerListModel {
  ...
  SalesLedgerListModel(this.date, this.balance, this.details, {this.id});
  ...
  factory SalesLedgerListModel.fromJson(Map<String, dynamic> json) =>
      _$SalesLedgerListModelFromJson(json);
