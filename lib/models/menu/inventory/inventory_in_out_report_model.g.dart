...
InventoryInOutReportModel _$InventoryInOutReportModelFromJson(
    ...
    InventoryInOutReportModel(
      ...
      InventoryReportQuantityModel.fromJson(
          json['out'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$InventoryInOutReportModelToJson(
        InventoryInOutReportModel instance) =>
    <String, dynamic>{
