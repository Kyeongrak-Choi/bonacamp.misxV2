...
class LendReportWarehouseModel {
  ...
  factory LendReportWarehouseModel.fromJson(Map<String, dynamic> json) => _$LendReportWarehouseModelFromJson(json);

  Map<String, dynamic> toJson() => _$LendReportWarehouseModelToJson(this);
}

List<LendReportWarehouseModel> generateLendReportWarehouseModelList(dataList, count) {
  return List.generate(
      ...
      (index) => LendReportWarehouseModel(
            ...
            LendReportQuantityModel(numberFormat.format(dataList[index].current.bottleQuantity),
                numberFormat.format(dataList[index].current.equipQuantity), numberFormat.format(dataList[index].current.quantity)),
