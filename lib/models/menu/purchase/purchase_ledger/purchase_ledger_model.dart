...
class PurchaseLedgerModel {
  ...
  PurchaseLedgerModel(this.code, this.name, this.balance, this.dateList,
      {this.id});
  ...
  factory PurchaseLedgerModel.fromJson(Map<String, dynamic> json) =>
      _$PurchaseLedgerModelFromJson(json);
